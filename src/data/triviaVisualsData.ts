...
const INITIAL_TRIVIA_VISUALS: Record<string, TriviaVisualInfo> = {
  ...
  't-03': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/b/b9/Harry_Mason_Silent_Hill.png/440px-Harry_Mason_Silent_Hill.png',
  ...
  't-05': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/7/7c/Minecraft_Steve.png/440px-Minecraft_Steve.png',
  ...
  't-09': {
    ...
    boxArtTitle: 'Pokémon Red & Blue (Game Boy)',
    boxArtImageUrl: 'https://images.unsplash.com/photo-1550745165-9bc0b252726f?auto=format&fit=crop&w=800&q=80',
  ...
  't-12': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/6/6f/Arthas_Menethil.png/440px-Arthas_Menethil.png',
  ...
  't-14': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/50/RyuStreetFighterTwoHadoken.png/512px-RyuStreetFighterTwoHadoken.png',
  ...
  't-15': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/a/a3/IAT_Crash_Bandicoot.png/512px-IAT_Crash_Bandicoot.png',
  ...
  't-16': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/0/07/Malenia_Blade_of_Miquella.png/440px-Malenia_Blade_of_Miquella.png',
  ...
  't-18': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/d/df/Chell_Portal.png/440px-Chell_Portal.png',
  ...
  't-25': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/5/53/TF2_Heavy.png/440px-TF2_Heavy.png',
  ...
  't-32': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/d/d4/Donkey_Kong_character.png/512px-Donkey_Kong_character.png',
  ...
  't-33': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/7/77/Crono_Trigger.png/440px-Crono_Trigger.png',
  ...
  't-37': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/4/4e/Wander_SotC.png/440px-Wander_SotC.png',
  ...
  't-39': {
    ...
    characterImageUrl: 'https://upload.wikimedia.org/wikipedia/en/thumb/f/f6/Alucard_SotN.png/440px-Alucard_SotN.png',
