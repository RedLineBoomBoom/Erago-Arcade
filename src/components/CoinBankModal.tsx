...
export const CoinBankModal: React.FC<CoinBankModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-3 sm:p-6 bg-black/85 backdrop-blur-md animate-fade-in select-none">
      <div className="relative w-full max-w-lg rounded-2xl border-4 border-black bg-[#14161F] p-5 sm:p-6 shadow-[8px_8px_0px_#FFE600] space-y-5 text-white animate-scale-up">
        {/* Header */}
        ...
        <div className="rounded-xl border-3 border-black bg-gradient-to-br from-[#1E2230] via-[#14161F] to-[#0B0C10] p-5 text-center space-y-2 shadow-[4px_4px_0px_#000]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {/* Points Progress */}
          <div className="rounded-xl border-2 border-black bg-[#1A1C26] p-3 space-y-2">
        ...
        <div className="rounded-xl border-2 border-black bg-[#0B0C10] p-3.5 space-y-2.5">
        ...
        <div className="flex flex-col sm:flex-row gap-2 pt-1">
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 p-2.5 rounded-lg border-2 border-black bg-[#00F5D4] text-black font-['Press_Start_2P'] text-[8px] font-bold shadow-[2px_2px_0px_#000] hover:bg-white"
          >
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 p-2.5 rounded-lg border-2 border-black bg-[#FF2A85] text-white font-['Press_Start_2P'] text-[8px] font-bold shadow-[2px_2px_0px_#000] hover:bg-white hover:text-black"
          >
